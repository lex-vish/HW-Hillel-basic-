...
# Rules of game "Rock Paper Scissors Lizard Spock"
...
def number_to_name(number):
    ...
    Порядок номерів подібран таким чином, щоб залишок від ділення на 5 різниці між числами, що відповідають канкуруючим сутностям,для домінуючої сутності не перевищував 2.
